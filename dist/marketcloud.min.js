...
e=function(a,b,d,g){d={success:d,error:g,headers:{}};d.headers.Authorization=c.token?c["public"]+":"+c.token:c["public"];0>a.indexOf("http://")&&(d.url=c.baseUrl+a);0<Object.keys(b).length&&(a=d.url,b=n(b,b),b=encodeURI(b.substring(0,b.length-1).split(" ").join("+")),d.url=a+("?"+b));d.method="GET";return h(d)},m=function(a,b,d){b={success:b,error:d,headers:{}};b.headers.Authorization=c.token?c["public"]+":"+c.token:c["public"];0>a.indexOf("http://")&&(b.url=c.baseUrl+a);b.method="DELETE";return h(b)},
f=function(a,b,d,g){b={success:d,error:g,data:b,headers:{}};b.headers.Authorization=c.token?c["public"]+":"+c.token:c["public"];0>a.indexOf("http://")&&(b.url=c.baseUrl+a);b.method="POST";return h(b)},p=function(a,b,d,g){b={success:d,error:g,data:b,headers:{}};b.headers.Authorization=c.token?c["public"]+":"+c.token:c["public"];0>a.indexOf("http://")&&(b.url=c.baseUrl+a);b.method="PATCH";return h(b)},q=function(a,b,d,g){b={success:d,error:g,data:b,headers:{}};b.headers.Authorization=c.token?c["public"]+
":"+c.token:c["public"];0>a.indexOf("http://")&&(b.url=c.baseUrl+a);b.method="PUT";return h(b)},w="object"==typeof self&&self.self===self&&self||"object"==typeof global&&global.global===global&&global||this,c={"public":null,token:null,baseUrl:"http://api.marketcloud.it/v0",storage:new l,getToken:function(){c.token||(c.token=c.storage.get("marketcloud.access_token"));return c.token},setToken:function(a){if("string"!==typeof a)throw Error("Token must be string.");c.token=a;c.storage.set("marketcloud.access_token",
