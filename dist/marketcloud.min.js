...
function(c,a,b){d.token=null;d.user=null;g("/users/authenticate",{password:a,email:c},function(a){d.setToken(a.data.token);d.user=a.data.user;b(null,a.data)},function(a){b(a.errors[0],null)})};d.users.authenticateWithFacebook=function(c,a,b){g("/users/authenticate/facebook",{access_token:a,user_id:c},function(a){d.setToken(a.data.token);d.user=a.data.user;b(null,a.data)},function(a){b(a.errors[0],null)})};d.users.logout=function(c){d.storage.del("marketcloud.access_token");d.storage.del("marketcloud.cart_id")};
d.carts.create=function(c,a){var b=null,b=c instanceof Array?{items:c}:c;g("/carts",b,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.carts.add=function(c,a,b){if(a instanceof Array)p("/carts/"+c,{op:"add",items:a},function(a){b(null,a.data)},function(a){b(a.errors[0],null)});else throw Error("addToCart(cart_id,data,callback) data must be an array [{product_id :1,quantity : 7}]");};d.carts.remove=function(c,a,b){if(a instanceof Array)p("/carts/"+c,[{op:"remove",items:a}],function(a){b(null,
a.data)},function(a){b(a.errors[0],null)});else throw Error("removeFromCart(cart_id,data,callback) data must be an array [{product_id :1,product_id : 7}]");};d.carts.update=function(c,a,b){if(a instanceof Array)p("/carts/"+c,[{op:"update",items:a}],function(a){b(null,a.data)},function(a){b(a.errors[0],null)});else throw Error("removeFromCart(cart_id,data,callback) data must be an array [{product_id :1,product_id : 7}]");};d.carts.getCurrent=function(c){var a=d.storage.get("marketcloud.cart_id");if(a)e("/carts/"+
a,{},function(a){c(null,a.data)},function(a){c(a.errors[0],null)});else return null};d.carts.getById=function(c,a){e("/carts/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.carts.getByUser=function(c){if(null===d.user)throw Error("Cannot get current user's cart without a user access token. You need to authenticate the user first.");e("/carts",{},function(a){c(null,a.data)},function(a){c(a.errors[0],null)})};d.carts["delete"]=function(c,a){m("/carts/"+c,function(b){a(null,b.data)},
function(b){a(b.errors[0],null)})};d.carts.checkout=function(c,a){if(!c.hasOwnProperty("cart_id")&&!c.hasOwnProperty("items")&&!d.storage.get("marketcloud.cart_id"))throw Error("marketcloud.carts.checkout(data,callback) missing cart data, provide cart_id or items array.");return d.orders.create(c,a)};d.token=d.getToken();w.marketcloud=d})();