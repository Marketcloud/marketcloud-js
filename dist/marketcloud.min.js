...
null)})};d.users.getCurrent=function(c){if(d.token)e("/users/current",{},function(a){c(null,a.data)},function(a){c(a.errors[0],null)});else throw Error("Cannot get current user iformation without a user access token. Obtain a user access token first.");};d.users.authenticate=function(c,a,b){d.token=null;d.user=null;g("/users/"+c+"/authenticate",{password:a},function(a){d.token=a.data.token;d.user=a.data.user;b(null,a.data)},function(a){b(a.errors[0],null)})};d.carts.create=function(c,a){var b=null,
b=c instanceof Array?{items:c}:c;g("/carts",b,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.carts.add=function(c,a,b){if(a instanceof Array)m("/carts/"+c,[{op:"add",items:a}],function(a){b(null,a.data)},function(a){b(a.errors[0],null)});else throw Error("addToCart(cart_id,data,callback) data must be an array [{product_id :1,quantity : 7}]");};d.carts.remove=function(c,a,b){if(a instanceof Array)m("/carts/"+c,[{op:"remove",items:a}],function(a){b(null,a.data)},function(a){b(a.errors[0],
...
d.carts.getByUser=function(c,a){e("/carts",{owner:c},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.carts.checkout=function(c,a){if("number"!==typeof c.cart_id)throw Error("marketcloud.carts.checkout(data,callback) data.cart_id must be Integer.");if("object"!==typeof c.billing_address)throw Error("marketcloud.carts.checkout(data,callback) data.billing_address must be Object.");if("object"!==typeof c.shipping_address)throw Error("marketcloud.carts.checkout(data,callback) data.shipping_address must be Object.");
g("/carts/"+c.cart_id+"/checkout",c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.carts["delete"]=function(c,a){h("/carts/"+c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};q.marketcloud=d})();