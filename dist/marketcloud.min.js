...
e=function(c,a,b,g){b={success:b,error:g,headers:{}};b.headers.Authorization=d.token?d["public"]+":"+d.token:d["public"];0>c.indexOf("http://")&&(b.url=d.baseUrl+c);0<Object.keys(a).length&&(c=b.url,a=n(a,a),a=encodeURI(a.substring(0,a.length-1).split(" ").join("+")),b.url=c+("?"+a));b.method="GET";return h(b)},m=function(c,a,b){a={success:a,error:b,headers:{}};a.headers.Authorization=d.token?d["public"]+":"+d.token:d["public"];0>c.indexOf("http://")&&(a.url=d.baseUrl+c);a.method="DELETE";return h(a)},
f=function(c,a,b,g){a={success:b,error:g,data:a,headers:{}};a.headers.Authorization=d.token?d["public"]+":"+d.token:d["public"];0>c.indexOf("http://")&&(a.url=d.baseUrl+c);a.method="POST";return h(a)},p=function(c,a,b,g){a={success:b,error:g,data:a,headers:{}};a.headers.Authorization=d.token?d["public"]+":"+d.token:d["public"];0>c.indexOf("http://")&&(a.url=d.baseUrl+c);a.method="PATCH";return h(a)},q=function(c,a,b,g){a={success:b,error:g,data:a,headers:{}};a.headers.Authorization=d.token?d["public"]+
...
c)},forgetToken:function(){d.token=null;d.storage.del("marketcloud.access_token")},setPublicKey:function(c){if("string"!==typeof c)throw Error("Public key must be string.");d["public"]=c},getPublicKey:function(){return d["public"]},addresses:{},brands:{},carts:{},categories:{},currencies:{},orders:{},payments:{},products:{},shippings:{},stores:{},taxes:{},users:{}};d.brands.list=function(c,a){e("/brands",c||{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.brands.getById=function(c,
a){e("/brands/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.addresses.create=function(c,a){f("/addresses/",c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.addresses.update=function(c,a,b){q("/addresses/"+c,a,function(a){b(null,a.data)},function(a){b(a.errors[0],null)})};d.addresses["delete"]=function(c,a){m("/addresses/"+c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.addresses.list=function(c,a){e("/addresses",c||{},function(b){a(null,
b.data)},function(b){a(b.errors[0],null)})};d.addresses.getById=function(c,a){e("/addresses/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.categories.list=function(c,a){e("/categories",c||{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.categories.getById=function(c,a){e("/categories/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.currencies.list=function(c,a){e("/currencies",c||{},function(b){a(null,b.data)},function(b){a(b.errors[0],
null)})};d.currencies.getById=function(c,a){e("/currencies/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.orders.create=function(c,a){f("/orders/",c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.orders.list=function(c,a){e("/orders",c||{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.orders.getById=function(c,a){e("/orders/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.products.list=function(c,a){e("/products",
c||{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.products.getById=function(c,a){e("/products/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.payments.create=function(c,a){if("object"!==typeof c)throw Error("First argument must be object");if(!c.hasOwnProperty("method"))throw Error("Must provide a payment method.");f("/payments",c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.shippings.list=function(c,a){e("/shippings",c||{},function(b){a(null,
b.data)},function(b){a(b.errors[0],null)})};d.shippings.getById=function(c,a){e("/shippings/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.stores.create=function(c,a){f("/stores/",c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.stores.update=function(c,a,b){q("/stores/"+c,a,function(a){b(null,a.data)},function(a){b(a.errors[0],null)})};d.stores["delete"]=function(c,a){m("/stores/"+c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.stores.list=
function(c,a){e("/stores",c||{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.stores.getById=function(c,a){e("/stores/"+c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.taxes.list=function(c,a){e("/taxes",c||{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.taxes.getById=function(c,a){e("/taxes/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.users.create=function(c,a){f("/users/",c,function(b){a(null,b.data)},function(b){a(b.errors[0],
null)})};d.users.update=function(c,a,b){q("/users/"+c,a,function(a){b(null,a.data)},function(a){b(a.errors[0],null)})};d.users["delete"]=function(c,a){m("/users/"+c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.users.list=function(c,a){e("/users",c||{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.users.getById=function(c,a){e("/users/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.users.isLoggedIn=function(){return d.token?!0:!1};d.users.getCurrent=
function(c){if(d.token)e("/users/current",{},function(a){c(null,a.data)},function(a){c(a.errors[0],null)});else throw k("Called users.getCurrent without a token"),Error("Cannot get current user information without a user access token. Obtain a user access token first.");};d.users.authenticate=function(c,a,b){d.token=null;d.user=null;f("/users/authenticate",{password:a,email:c},function(a){d.setToken(a.data.token);d.user=a.data.user;b(null,a.data)},function(a){b(a.errors[0],null)})};d.users.authenticateWithFacebook=
function(c,a,b){f("/users/authenticate/facebook",{access_token:a,user_id:c},function(a){d.setToken(a.data.token);d.user=a.data.user;b(null,a.data)},function(a){b(a.errors[0],null)})};d.users.logout=function(c){d.token=null;d.storage.del("marketcloud.access_token");d.storage.del("marketcloud.cart_id");c&&c()};d.carts.create=function(c,a){var b=null,b=c instanceof Array?{items:c}:c;f("/carts",b,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.carts.add=function(c,a,b){if(a instanceof
Array)p("/carts/"+c,{op:"add",items:a},function(a){b(null,a.data)},function(a){b(a.errors[0],null)});else throw Error("addToCart(cart_id,data,callback) data must be an array [{product_id :1,quantity : 7}]");};d.carts.remove=function(c,a,b){if(a instanceof Array)p("/carts/"+c,[{op:"remove",items:a}],function(a){b(null,a.data)},function(a){b(a.errors[0],null)});else throw Error("removeFromCart(cart_id,data,callback) data must be an array [{product_id :1,product_id : 7}]");};d.carts.update=function(c,
a,b){if(a instanceof Array)p("/carts/"+c,[{op:"update",items:a}],function(a){b(null,a.data)},function(a){b(a.errors[0],null)});else throw Error("removeFromCart(cart_id,data,callback) data must be an array [{product_id :1,product_id : 7}]");};d.carts.getCurrent=function(c){var a=d.storage.get("marketcloud.cart_id");if(a)e("/carts/"+a,{},function(a){c(null,a.data)},function(a){c(a.errors[0],null)});else return null};d.carts.getById=function(c,a){e("/carts/"+c,{},function(b){a(null,b.data)},function(b){a(b.errors[0],
null)})};d.carts.getByUser=function(c){if(null===d.user)throw Error("Cannot get current user's cart without a user access token. You need to authenticate the user first.");e("/carts",{},function(a){c(null,a.data)},function(a){c(a.errors[0],null)})};d.carts["delete"]=function(c,a){m("/carts/"+c,function(b){a(null,b.data)},function(b){a(b.errors[0],null)})};d.carts.checkout=function(c,a){if(!c.hasOwnProperty("cart_id")&&!c.hasOwnProperty("items")&&!d.storage.get("marketcloud.cart_id"))throw Error("marketcloud.carts.checkout(data,callback) missing cart data, provide cart_id or items array.");
return d.orders.create(c,a)};d.token=d.getToken();w.marketcloud=d})();